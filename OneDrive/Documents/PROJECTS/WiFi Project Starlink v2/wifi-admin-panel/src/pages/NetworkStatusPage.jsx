        ...
        return (
            <div className="bg-slate-50 min-h-screen p-8 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-slate-600">Cargando estado de la red...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                    <div className="text-center sm:text-left">
                        <h1 className="text-4xl font-bold text-slate-800 mb-2">Estado de la Red Starlink</h1>
                        <p className="text-slate-500">Monitoreo en tiempo real de la conexión a internet en Limón, Costa Rica</p>
                    </div>
                    <div className="flex justify-center sm:justify-end">
                        <button
                            onClick={handleReload}
                            disabled={isReloading}
                            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors shadow-lg hover:shadow-xl"
                        >
                            {isReloading ? (
                                <>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-lg mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-bold text-slate-800 mb-2">Estado Actual</h2>
                        ...
                        <div className="text-right">
                            <p className="text-slate-500 text-sm">Última actualización</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                        <p className="text-slate-500 text-sm mb-2">Uptime (24h)</p>
                        <p className="text-3xl font-bold text-green-600">{uptime.percent}%</p>
                        <p className="text-sm text-slate-600">{uptime.hours}h {uptime.minutes}m</p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                        <p className="text-slate-500 text-sm mb-2">Velocidad de Descarga</p>
                        <p className="text-3xl font-bold text-blue-600">{currentStatus?.downloadSpeed || 0}</p>
                        <p className="text-sm text-slate-600">Mbps</p>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                        <p className="text-slate-500 text-sm mb-2">Velocidad de Subida</p>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                        <p className="text-slate-500 text-sm mb-2">Latencia (Ping)</p>
                        <p className="text-3xl font-bold text-purple-600">{currentStatus?.latency || 0}</p>
                        <p className="text-sm text-slate-600">ms</p>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-lg">
                    <h3 className="text-2xl font-bold text-slate-800 mb-4">Rendimiento de las Últimas 24 Horas</h3>
                    <div className="h-96">
